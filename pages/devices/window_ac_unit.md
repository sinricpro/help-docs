...
4. Enter the device name: **acunit** and description: **living rooom acunit**.
...
![Sinric Pro alexa arduino esp8266 esp32 window ac unit]({{ site.github.url }}/public/img/sinricpro_alexa_ac-unit_push_notification.jpg)
