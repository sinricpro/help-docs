...
Now you should be able to see the air quality status and water level via Alexa, Sinric Pro App
...
2️⃣ Create an Alexa Routine that speaks your message when a "Air quality is bad!" when Switch turned on
